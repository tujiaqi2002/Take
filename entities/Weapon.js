import { context, player, Enemies, secondsPassed } from "../utils/config.js";
...
export default class Weapon{
  ...
  shoot(){
    var newBullet = new Bullet(this.coordinate.x, this.coordinate.y, this.angle, this.bulletSpeed);
